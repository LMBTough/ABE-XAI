...
import os
import warnings
from salicncy import chefer, gradcam, saliencymap, fast_ig, mfaba, rise, m2ib
...
argparser.add_argument("--method", type=str, default="m2ib", choices=[
                       "chefer", "gradcam", "saliencymap", "fast_ig", "mfaba", "rise", "m2ib"])
...
if __name__ == "__main__":
    ...
    for x, caption, batch_xs in dataloader:
        ...
        elif args.method in ['abm']:
            v_saliency, t_saliency = abm(
